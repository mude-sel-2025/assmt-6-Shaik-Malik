...
def confidence_interval(N_samples=40, sample_size=30, true_mean=75, true_std=11.25, confidence=0.95):
    """
    ...
    for i in range(N_samples):
        ...
        if lower > true_mean or upper < true_mean:
            misses += 1
        # this code block ends here
    ...
    print(f"This is roughly {misses/N_samples*100:.2f}%, close to the expected 5% for a 95% CI.")
    # this code block ends here
